/**
 * Guest side of the app-web ↔ sandbox preview postMessage bridge.
 *
 * Activates only when this page is framed by an allowlisted app embedder.
...
export const PREVIEW_BRIDGE_CHANNEL = "app-preview-bridge" as const;
 ...
 * Noops (returns a no-op dispose) when not embedded under an app parent.
 */
