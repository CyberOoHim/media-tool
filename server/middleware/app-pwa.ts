 ...
 *   OG identity is baked via `virtual:app-og-identity` at `vite build`
...
import {
  ...
  renderWebManifest,
} from "../../scripts/app-pwa-shared.mjs";
...
export default async function appPwaMiddleware(
  event: AppPwaEvent,
